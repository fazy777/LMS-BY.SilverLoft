  ...
  return (
    <div ref={containerRef} className={`header-search relative ${className}`} style={{ width: '100%' }}>
      ...
      {isOpen && query.trim().length > 0 && (
        <div
          className="search-dropdown-menu absolute left-0 right-0 top-full mt-2 bg-white rounded-2xl shadow-[0_16px_40px_rgba(17,42,70,0.16)] border border-[#E2E8F0] py-2 z-50 overflow-hidden text-left"
          style={{ minWidth: 280, maxHeight: 420, overflowY: 'auto' }}
        >
          {loading ? (
